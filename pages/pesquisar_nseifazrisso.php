    ...
    <div id="main-container" class="flex-grow flex flex-col min-h-screen relative">
        ...
        <main class="flex-grow flex flex-col items-center justify-start pt-16 px-6">
            ...
            <div class="w-full max-w-3xl flex flex-col items-center text-center space-y-10">
                ...
                <a href="https://github.com/emanuecaIFFar/IFeed/tree/main" class="mt-12 flex items-center gap-4 px-8 py-5 bg-[#1E1E1E] border border-[#333] rounded-xl text-white hover:bg-[#2a2a2a] hover:border-white/30 transition-all duration-300 group shadow-xl">
